...
MART_NAME = "pjm_modelling_solar_forecast_hourly_da_cutoff"
...
@flow(name="PJM Modelling Solar Forecast Hourly DA Cutoff")
def pjm_modelling_solar_forecast_hourly_da_cutoff():
    """Refresh the pjm_modelling solar forecast DA cutoff table and sync to Azure Blob parquet."""
...
if __name__ == "__main__":
    pjm_modelling_solar_forecast_hourly_da_cutoff()
