...
MART_NAME = "pjm_modelling_load_forecast_hourly_da_cutoff"
...
@flow(name="PJM Modelling Load Forecast Hourly DA Cutoff")
def pjm_modelling_load_forecast_hourly_da_cutoff():
    """Refresh the pjm_modelling load forecast DA cutoff table and sync to Azure Blob parquet."""
...
if __name__ == "__main__":
    pjm_modelling_load_forecast_hourly_da_cutoff()
