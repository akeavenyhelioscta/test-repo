...
---------------------------
-- SELECT & CAST raw WSI hourly observed weather
-- WSI Hour column is 0..23 = hour STARTING (0 = midnight start), per page 21
-- of the WSI Trader API docs. Naming kept honest here; staging derives a
-- PJM-convention hour_ending = hour_starting + 1.
---------------------------
