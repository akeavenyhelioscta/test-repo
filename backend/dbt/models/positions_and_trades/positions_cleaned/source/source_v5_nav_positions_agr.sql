...
WITH NAV_AGR_POSITIONS as (
    ...
    -- FROM nav.nav_sftp_positions_agr_v2_2026_feb_23 nav
    FROM {{ source('nav_v5', 'nav_sftp_positions_agr_v2_2026_feb_23') }}
),

-- SELECT * FROM NAV_PNT_POSITIONS
...
NAV_AGR_POSITIONS_FORMATTED as (
    SELECT
...
SELECT * FROM NAV_AGR_POSITIONS_FORMATTED
ORDER BY sftp_date desc, contract_yyyymm ASC
