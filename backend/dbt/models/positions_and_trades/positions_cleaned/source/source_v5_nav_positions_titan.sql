...
WITH NAV_TITAN_POSITIONS as (
    ...
    FROM {{ source('nav_v5', 'nav_sftp_positions_titan_v2_2026_feb_23') }}
),

-- SELECT * FROM NAV_TITAN_POSITIONS
...
NAV_TITAN_POSITIONS_FORMATTED as (
    SELECT
...
SELECT * FROM NAV_TITAN_POSITIONS_FORMATTED
ORDER BY sftp_date desc, contract_yyyymm ASC
