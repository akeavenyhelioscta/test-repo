...
def _upsert(
    ...
    primary_key_candidates = ['interval_start_local','interval_start_utc','interval_end_local','interval_end_utc','market','location_id','location_name','location_short_name','location_type','lmp','energy','congestion','loss',]
