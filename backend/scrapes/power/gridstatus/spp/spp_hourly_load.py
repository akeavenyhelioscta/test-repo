...
# SCRAPE
API_SCRAPE_NAME = "spp_hourly_load"
...
def _format(
    ...
    # dtypes
    columns = ['csws', 'ede', 'grda', 'indn', 'kacy', 'kcpl', 'les', 'mps', 'nppd', 'okge', 'oppd', 'seci', 'sprm', 'sps', 'waue', 'wfec', 'wr', 'system_total']
...
def main(
        dates: list = [(datetime.now() - relativedelta(days=7), datetime.now())],
    ):
