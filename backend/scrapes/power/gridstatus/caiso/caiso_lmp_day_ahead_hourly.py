...
# SCRAPE
API_SCRAPE_NAME = "caiso_lmp_day_ahead_hourly"
...
def _format(
    ...
    # dtypes
    columns = ['location', 'location_type', 'market', 'lmp', 'energy', 'congestion', 'loss']
...
def _upsert(
    ...
    primary_keys = ['interval_start_local', 'interval_start_utc', 'interval_end_local', 'interval_end_utc', 'market', 'location', 'location_type', 'lmp', 'energy', 'congestion', 'loss']
