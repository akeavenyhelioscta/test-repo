...
# SCRAPE
API_SCRAPE_NAME = "caiso_fuel_mix"
...
def _format(
    ...
    # dtypes
    columns = ['solar', 'wind', 'geothermal', 'biomass', 'biogas', 'small_hydro', 'coal', 'nuclear', 'natural_gas', 'large_hydro', 'batteries', 'imports', 'other']
...
def main(
        dates: list[str] = ["latest", "today", str(datetime.now().date() - timedelta(days=1))],
    ):
