...
# SCRAPE
API_SCRAPE_NAME = "caiso_lmp_real_time_15_min"
...
def _format(
    ...
    # dtypes
    columns = ['market', 'location', 'location_type', 'lmp', 'energy', 'congestion', 'loss', 'ghg']
...
def _upsert(
    ...
    primary_keys = ['interval_start_local', 'interval_start_utc', 'interval_end_local', 'interval_end_utc', 'market', 'location', 'location_type', 'lmp', 'energy', 'congestion', 'loss', 'ghg']
