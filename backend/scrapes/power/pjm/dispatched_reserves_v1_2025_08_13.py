...
# SCRAPE
API_SCRAPE_NAME = "dispatched_reserves"
...
def _pull(
    ...
    https://dataminer2.pjm.com/feed/dispatched_reserves/definition
        ...
        Last Updated: 8/13/2025 11:58
        First Available: N/A
    """

    url = f"https://api.pjm.com/api/v1/dispatched_reserves?rowCount=50000&startRow=1&datetime_beginning_ept={start_date}%2000:00%20to%20{end_date}%2023:00&format=csv&subscription-key=0e3e44aa6bde4d5da1699fda4511235e"
...
def _upsert(
    ...
    azure_postgresql.upsert_to_azure_postgresql(
        ...
        primary_key = ['datetime_beginning_utc', 'datetime_beginning_ept', 'area', 'reserve_type'],
    )
