...
# SCRAPE
API_SCRAPE_NAME = "operational_reserves"
...
def _pull(
    ...
    https://dataminer2.pjm.com/feed/operational_reserves/definition
        ...
        Posting Frequency: Every 15 seconds
        Update Availability: Every 15 seconds
        Retention Time: 15 days
        Last Updated: 8/13/2025 12:07:32
        First Available: N/A
    """

    url = f"https://api.pjm.com/api/v1/operational_reserves?rowCount=50000&startRow=1&datetime_beginning_ept={start_date}%2000:00%20to%20{end_date}%2023:00&format=csv&subscription-key=0e3e44aa6bde4d5da1699fda4511235e"
...
def _upsert(
    ...
    azure_postgresql.upsert_to_azure_postgresql(
        ...
        primary_key = ['datetime_beginning_utc', 'datetime_beginning_ept', 'reserve_name'],
    )
