...
def _pull(
    ...
    """
        ...
        This feed lists the hourly day-ahead bid data for each market day for PJM, Mid Atlantic and Western regions.

        Posting Frequency: Daily
        Update Availability: Daily between 12:00 p.m. and 02:00 p.m.
        Retention Time: Indefinitely
        Last Updated: 4/28/2025 11:22
        First Available: 6/2/2000 00:00
    """

    url = f"https://api.pjm.com/api/v1/hrl_dmd_bids?rowCount=50000&startRow=1&datetime_beginning_ept={start_date}%2000:00%20to%20{end_date}%2023:00&format=csv&subscription-key=0e3e44aa6bde4d5da1699fda4511235e"
