...
# SCRAPE
API_SCRAPE_NAME = "five_min_instantaneous_load_v1_2025_OCT_15"
...
def _pull(
    ...
    """
    Instantaneous Load
    https://dataminer2.pjm.com/feed/inst_load/definition

        Posting Frequency: Every 5 minutes
        Update Availability: Every 5 minutes
        Retention Time: 30 days
        Last Updated: 10/15/2025 13:55
        First Available: N/A
    """

    url = f"https://api.pjm.com/api/v1/inst_load?rowCount=50000&startRow=1&datetime_beginning_ept={start_date}%2000:00%20to%20{end_date}%2023:00&format=csv&subscription-key=0e3e44aa6bde4d5da1699fda4511235e"
...
def _upsert(
    ...
    primary_keys = ['datetime_beginning_utc', 'datetime_beginning_ept', 'area']
