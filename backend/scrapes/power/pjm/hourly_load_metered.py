...
# SCRAPE
API_SCRAPE_NAME = "hourly_load_metered"
...
def _pull(
    ...
    """
        ...
        Update Availability: Daily 05:30 a.m.
        Retention Time: Indefinitely
        Last Updated: 10/21/2024 03:49
        First Available: 1/1/1993 00:00
    """

    url = f"https://api.pjm.com/api/v1/hrl_load_metered?rowCount=50000&startRow=1&datetime_beginning_ept={start_date}%2000:00%20to%20{end_date}%2023:00&format=csv&subscription-key=0e3e44aa6bde4d5da1699fda4511235e"
...
def _upsert(
        ...
        primary_key = ['datetime_beginning_utc', 'nerc_region', 'mkt_region', 'zone', 'load_area', 'is_verified'],
    ):
