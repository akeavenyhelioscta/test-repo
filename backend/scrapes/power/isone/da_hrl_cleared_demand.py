...
# SCRAPE
API_SCRAPE_NAME = "da_hrl_cleared_demand"
...
def _pull(
    ...
    """
    https://www.iso-ne.com/isoexpress/web/reports/load-and-demand/-/tree/dmnd-da-hourly-cleared

    Release:
        November 12, 2024 ... 11/11/2024 12:31 PM EST
        November 11, 2024 ... 11/10/2024 12:36 PM EST
        November 10, 2024 ... 11/09/2024 12:26 PM EST
    """
    ...
    # build url
    url = f"https://www.iso-ne.com/transform/csv/hourlydayaheaddemand?start={start_date.strftime('%Y%m%d')}&end={end_date.strftime('%Y%m%d')}"
