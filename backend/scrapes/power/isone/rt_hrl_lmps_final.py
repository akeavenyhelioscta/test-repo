...
def _pull(
    ...
    """
    RT final LMPs are typically published 2-5 days after the operating day.
    ...
    url = f"https://www.iso-ne.com/static-transform/csv/histRpts/rt-lmp/lmp_rt_final_{start_date.strftime('%Y%m%d')}.csv"
