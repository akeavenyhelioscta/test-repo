"""
Runner for manually executing ERCOT Python scripts.
...
EXCLUDE = ("__init__.py", "run.py", "runs.py", "flows.py", "ercot_api_utils.py")


def discover_scripts() -> list[Path]:
    """Find all .py scripts in the ercot directory (excluding orchestration files)."""
    return sorted(
...
def display_menu(scripts: list[Path]) -> None:
    """Print a numbered list of available ERCOT scripts."""
    print("\n=== Available ERCOT Scripts ===\n")
