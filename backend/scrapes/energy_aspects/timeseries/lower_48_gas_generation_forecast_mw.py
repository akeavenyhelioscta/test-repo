"""
Energy Aspects — Lower 48 Gas Generation Forecast (MW).

US48 natural gas generation from the regional power balances model.
Source: .refactor/energy_aspects_v1_2025_dec_28/lower_48_gas_generation_forecast_mw.csv
"""
...
API_SCRAPE_NAME = "lower_48_gas_generation_forecast_mw"
...
# US48 natural gas generation (EA price variant matches v1 CSV)
DATASET_IDS = [6725]
