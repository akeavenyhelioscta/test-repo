"""
Runner for manually executing Energy Aspects timeseries scripts.
...
def discover_scripts() -> list[Path]:
    """Find all .py scripts in the timeseries directory."""
    return sorted(
...
def display_menu(scripts: list[Path]) -> None:
    """Print a numbered list of available timeseries scripts."""
    print("\n=== Energy Aspects / Timeseries Scripts ===\n")
...
def main():
    config = RunnerConfig(
        name="Energy Aspects / Timeseries",
