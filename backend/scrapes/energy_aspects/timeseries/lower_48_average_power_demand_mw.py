"""
Energy Aspects — Lower 48 Average Power Demand (MW).

ISO-level demand datasets from the regional power balances model.
Source: .refactor/energy_aspects_v1_2025_dec_28/lower_48_average_power_demand_mw.csv
"""
...
API_SCRAPE_NAME = "lower_48_average_power_demand_mw"
...
# ISO-level demand datasets (actual load / forecast load under normal weather)
DATASET_IDS = [6612, 6659, 6627, 6580, 6642, 6674, 6597]
