"""
Return the WSI Average Temperature forecast in degrees Fahrenheit for all cities in each configured pool region.
"""
...
# SCRAPE
API_SCRAPE_NAME = "wsi_homepage_forecast_table_avg_v1_2026_jan_12"
...
def _pull(
    ...
    if df.empty:
        raise ValueError(f"Homepage AverageTemp response parsed to empty dataframe for region={region}")
