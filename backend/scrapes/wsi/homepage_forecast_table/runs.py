"""
Runner for manually executing WSI Homepage Forecast Table scripts.
...
def discover_scripts() -> list[Path]:
    """Find runnable Homepage Forecast Table scripts."""
    scripts: list[Path] = []
...
def display_menu(scripts: list[Path]) -> None:
    ...
    print("\n=== Available WSI Homepage Forecast Table Scripts ===\n")
...
def main() -> None:
    config = RunnerConfig(
        name="WSI Homepage Forecast Table",
