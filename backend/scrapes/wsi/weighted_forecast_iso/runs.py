"""
Runner for manually executing WSI Weighted Forecast ISO/Country scripts.
...
def discover_scripts() -> list[Path]:
    """Find runnable Weighted Forecast ISO/Country scripts."""
    scripts: list[Path] = []
...
def display_menu(scripts: list[Path]) -> None:
    ...
    print("\n=== Available WSI Weighted Forecast ISO/Country Scripts ===\n")
...
def main() -> None:
    config = RunnerConfig(
        name="WSI Weighted Forecast ISO/Country",
