"""
Runner for manually executing WSI Historical Observations scripts.
...
def discover_scripts() -> list[Path]:
    """Find runnable Historical Observations scripts."""
    scripts: list[Path] = []
...
def display_menu(scripts: list[Path]) -> None:
    ...
    print("\n=== Available WSI Historical Observations Scripts ===\n")
...
def main() -> None:
    config = RunnerConfig(
        name="WSI Historical Observations",
