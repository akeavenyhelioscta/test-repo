"""
Runner for manually executing WSI Weighted Degree Day scripts.
...
def discover_scripts() -> list[Path]:
    """Find runnable Weighted Degree Day scripts."""
    scripts: list[Path] = []
...
def display_menu(scripts: list[Path]) -> None:
    ...
    print("\n=== Available WSI Weighted Degree Day Scripts ===\n")
