"""
Runner for manually executing WSI Weighted Forecast Individual City scripts.
...
def discover_scripts() -> list[Path]:
    """Find runnable Weighted Forecast Individual City scripts."""
    scripts: list[Path] = []
...
def display_menu(scripts: list[Path]) -> None:
    ...
    print("\n=== Available WSI Weighted Forecast Individual City Scripts ===\n")
...
def main() -> None:
    config = RunnerConfig(
        name="WSI Weighted Forecast Individual City",
