"""
ICE PJM power futures product registry.
...
Symbols are built at runtime:  ``{product} {strip}{YY}-IUS``
    e.g. ``PMI H26-IUS`` = PJM Western Hub RT Peak, March 2026
...
def get_pjm_power_futures_products() -> list[dict]:
    ...
    return PJM_POWER_FUTURES_PRODUCTS
...
def build_ice_symbol(
    ...
    Example: build_ice_symbol("PMI", "H", 2026) -> "PMI H26-IUS"
    """
