"""
ICE intraday quote snapshots for PJM power products.

Pulls Open/High/Low/Bid/Ask/Last/Volume/VWAP/Settle/Recent Settlement
for every symbol in the PJM symbol registry and upserts long-format rows to
...
15 minutes during PJM market hours.
"""
...
API_SCRAPE_NAME = "runner_pjm_short_term"
...
def _pull(
    ...
    """Fetch a single snapshot of quote data from ICE for selected PJM symbols."""
...
def main(
    ...
    symbols : list[str] | None
        ...
        ``backend/scrapes/ice_python/symbols/pjm_short_term_symbols.py`` are processed.
