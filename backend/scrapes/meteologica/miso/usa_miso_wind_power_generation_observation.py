"""
Meteologica: USA MISO wind power generation observation

Content ID: 2289
Content Name: USA MISO wind power generation observation
...
API_SCRAPE_NAME = "usa_miso_wind_power_generation_observation"
CONTENT_ID = 2289
