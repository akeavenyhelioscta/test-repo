"""
Meteologica: USA MISO photovoltaic power generation observation

Content ID: 2333
Content Name: USA MISO photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_miso_pv_power_generation_observation"
CONTENT_ID = 2333
