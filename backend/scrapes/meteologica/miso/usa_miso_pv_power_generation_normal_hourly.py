"""
Meteologica: USA MISO photovoltaic power generation normal hourly

Content ID: 2340
Content Name: USA MISO photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_miso_pv_power_generation_normal_hourly"
CONTENT_ID = 2340
