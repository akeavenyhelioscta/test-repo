"""
Meteologica: USA MISO wind power generation normal hourly

Content ID: 2292
Content Name: USA MISO wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_miso_wind_power_generation_normal_hourly"
CONTENT_ID = 2292
