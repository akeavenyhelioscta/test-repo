"""
Meteologica: USA MISO power demand forecast Meteologica hourly

Content ID: 2145
Content Name: USA MISO power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_miso_power_demand_forecast_hourly"
CONTENT_ID = 2145
