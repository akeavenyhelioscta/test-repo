"""
Meteologica: USA MISO wind power generation forecast Meteologica hourly

Content ID: 2188
Content Name: USA MISO wind power generation forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_miso_wind_power_generation_forecast_hourly"
CONTENT_ID = 2188
