"""
Meteologica: USA ERCOT wind power generation observation

Content ID: 1929
Content Name: USA ERCOT wind power generation observation
...
API_SCRAPE_NAME = "usa_ercot_wind_power_generation_observation"
CONTENT_ID = 1929
