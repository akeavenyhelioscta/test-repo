"""
Meteologica: USA ERCOT Coast power demand forecast Meteologica hourly

Content ID: 1945
Content Name: USA ERCOT Coast power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_ercot_coast_power_demand_forecast_hourly"
CONTENT_ID = 1945
