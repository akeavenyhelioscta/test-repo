"""
Meteologica: USA ERCOT photovoltaic power generation observation

Content ID: 1865
Content Name: USA ERCOT photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_ercot_pv_power_generation_observation"
CONTENT_ID = 1865
