"""
Meteologica: USA ERCOT photovoltaic power generation normal hourly

Content ID: 1866
Content Name: USA ERCOT photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_ercot_pv_power_generation_normal_hourly"
CONTENT_ID = 1866
