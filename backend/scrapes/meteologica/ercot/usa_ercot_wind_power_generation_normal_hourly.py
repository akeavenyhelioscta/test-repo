"""
Meteologica: USA ERCOT wind power generation normal hourly

Content ID: 1936
Content Name: USA ERCOT wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_ercot_wind_power_generation_normal_hourly"
CONTENT_ID = 1936
