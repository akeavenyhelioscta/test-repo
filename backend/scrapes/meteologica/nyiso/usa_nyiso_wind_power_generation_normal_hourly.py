"""
Meteologica: USA NYISO wind power generation normal hourly

Content ID: 2474
Content Name: USA NYISO wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_nyiso_wind_power_generation_normal_hourly"
CONTENT_ID = 2474
