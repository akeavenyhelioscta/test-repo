"""
Meteologica: USA NYISO hydro power generation total normal hourly

Content ID: 2527
Content Name: USA NYISO hydro power generation total normal hourly
...
API_SCRAPE_NAME = "usa_nyiso_hydro_power_generation_normal_hourly"
CONTENT_ID = 2527
