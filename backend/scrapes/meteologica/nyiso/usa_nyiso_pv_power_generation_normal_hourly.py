"""
Meteologica: USA NYISO photovoltaic power generation normal hourly

Content ID: 2548
Content Name: USA NYISO photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_nyiso_pv_power_generation_normal_hourly"
CONTENT_ID = 2548
