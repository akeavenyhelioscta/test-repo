"""
Meteologica: USA NYISO wind power generation observation

Content ID: 2473
Content Name: USA NYISO wind power generation observation
...
API_SCRAPE_NAME = "usa_nyiso_wind_power_generation_observation"
CONTENT_ID = 2473
