"""
Meteologica: USA ISO-NE power demand forecast Meteologica hourly

Content ID: 2095
Content Name: USA ISO-NE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_isone_power_demand_forecast_hourly"
CONTENT_ID = 2095
