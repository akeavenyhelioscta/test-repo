"""
Meteologica: USA ISO-NE photovoltaic power generation observation

Content ID: 2026
Content Name: USA ISO-NE photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_isone_pv_power_generation_observation"
CONTENT_ID = 2026
