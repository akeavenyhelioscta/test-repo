"""
Meteologica: USA ISO-NE photovoltaic power generation normal hourly

Content ID: 2027
Content Name: USA ISO-NE photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_isone_pv_power_generation_normal_hourly"
CONTENT_ID = 2027
