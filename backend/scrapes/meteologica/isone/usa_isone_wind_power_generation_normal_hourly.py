"""
Meteologica: USA ISO-NE wind power generation normal hourly

Content ID: 2094
Content Name: USA ISO-NE wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_isone_wind_power_generation_normal_hourly"
CONTENT_ID = 2094
