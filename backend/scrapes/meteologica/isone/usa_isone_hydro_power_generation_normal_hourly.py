"""
Meteologica: USA ISO-NE hydro power generation total normal hourly

Content ID: 2135
Content Name: USA ISO-NE hydro power generation total normal hourly
...
API_SCRAPE_NAME = "usa_isone_hydro_power_generation_normal_hourly"
CONTENT_ID = 2135
