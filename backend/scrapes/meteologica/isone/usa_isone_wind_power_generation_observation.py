"""
Meteologica: USA ISO-NE wind power generation observation

Content ID: 2093
Content Name: USA ISO-NE wind power generation observation
...
API_SCRAPE_NAME = "usa_isone_wind_power_generation_observation"
CONTENT_ID = 2093
