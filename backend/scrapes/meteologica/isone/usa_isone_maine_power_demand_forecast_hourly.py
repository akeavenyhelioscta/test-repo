"""
Meteologica: USA ISO-NE Maine power demand forecast Meteologica hourly

Content ID: 2096
Content Name: USA ISO-NE Maine power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_isone_maine_power_demand_forecast_hourly"
CONTENT_ID = 2096
