"""
Meteologica: USA ISO-NE hydro power generation total forecast Meteologica daily

Content ID: 2132
Content Name: USA ISO-NE hydro power generation total forecast Meteologica daily
...
API_SCRAPE_NAME = "usa_isone_hydro_power_generation_forecast_daily"
CONTENT_ID = 2132
...
def main():
    ...
    try:
        ...
        logger.section("Pulling latest data...")
        df, metadata = _pull()
