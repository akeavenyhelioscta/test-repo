"""
Meteologica: USA US48 hydro power generation total forecast Meteologica daily

Content ID: 8118
Content Name: USA US48 hydro power generation total forecast Meteologica daily
...
API_SCRAPE_NAME = "usa_us48_hydro_power_generation_forecast_daily"
CONTENT_ID = 8118
...
# This content type has a unique schema: only "Date yyyy-mm-dd" and "forecast"
COLUMN_RENAME_MAP = {
    "Date yyyy-mm-dd": "forecast_date",
...
def _upsert(
    ...
    Primary key: (update_id, forecast_date)
        - update_id uniquely identifies the forecast batch
        - forecast_date uniquely identifies the day within that batch
    """
    primary_keys = ["update_id", "forecast_date"]
