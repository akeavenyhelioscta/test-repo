"""
Meteologica: USA CAISO PACE power demand forecast Meteologica hourly

Content ID: 1786
Content Name: USA CAISO PACE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_pace_power_demand_forecast_hourly"
CONTENT_ID = 1786
