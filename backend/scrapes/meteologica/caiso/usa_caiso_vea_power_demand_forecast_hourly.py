"""
Meteologica: USA CAISO VEA power demand forecast Meteologica hourly

Content ID: 1792
Content Name: USA CAISO VEA power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_vea_power_demand_forecast_hourly"
CONTENT_ID = 1792
