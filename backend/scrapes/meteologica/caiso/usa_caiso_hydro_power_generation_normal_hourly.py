"""
Meteologica: USA CAISO hydro power generation total normal hourly

Content ID: 1832
Content Name: USA CAISO hydro power generation total normal hourly
...
API_SCRAPE_NAME = "usa_caiso_hydro_power_generation_normal_hourly"
CONTENT_ID = 1832
