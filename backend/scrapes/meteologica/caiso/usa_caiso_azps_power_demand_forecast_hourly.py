"""
Meteologica: USA CAISO AZPS power demand forecast Meteologica hourly

Content ID: 1793
Content Name: USA CAISO AZPS power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_azps_power_demand_forecast_hourly"
CONTENT_ID = 1793
