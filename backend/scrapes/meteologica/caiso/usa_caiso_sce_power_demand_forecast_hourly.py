"""
Meteologica: USA CAISO SCE power demand forecast Meteologica hourly

Content ID: 1791
Content Name: USA CAISO SCE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_sce_power_demand_forecast_hourly"
CONTENT_ID = 1791
