"""
Meteologica: USA CAISO wind power generation normal hourly

Content ID: 1782
Content Name: USA CAISO wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_caiso_wind_power_generation_normal_hourly"
CONTENT_ID = 1782
