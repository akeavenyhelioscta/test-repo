"""
Meteologica: USA CAISO wind power generation observation

Content ID: 1779
Content Name: USA CAISO wind power generation observation
...
API_SCRAPE_NAME = "usa_caiso_wind_power_generation_observation"
CONTENT_ID = 1779
