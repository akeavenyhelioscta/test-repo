"""
Meteologica: USA CAISO PSEI power demand forecast Meteologica hourly

Content ID: 1794
Content Name: USA CAISO PSEI power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_psei_power_demand_forecast_hourly"
CONTENT_ID = 1794
