"""
Meteologica: USA CAISO photovoltaic power generation observation

Content ID: 1744
Content Name: USA CAISO photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_caiso_pv_power_generation_observation"
CONTENT_ID = 1744
