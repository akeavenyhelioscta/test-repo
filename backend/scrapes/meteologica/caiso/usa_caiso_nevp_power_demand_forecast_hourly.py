"""
Meteologica: USA CAISO NEVP power demand forecast Meteologica hourly

Content ID: 1787
Content Name: USA CAISO NEVP power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_nevp_power_demand_forecast_hourly"
CONTENT_ID = 1787
