"""
Meteologica: USA CAISO photovoltaic power generation normal hourly

Content ID: 1748
Content Name: USA CAISO photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_caiso_pv_power_generation_normal_hourly"
CONTENT_ID = 1748
