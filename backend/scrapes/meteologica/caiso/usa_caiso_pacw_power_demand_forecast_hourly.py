"""
Meteologica: USA CAISO PACW power demand forecast Meteologica hourly

Content ID: 1789
Content Name: USA CAISO PACW power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_pacw_power_demand_forecast_hourly"
CONTENT_ID = 1789
