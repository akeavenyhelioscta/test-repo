"""
Meteologica: USA CAISO SDGE power demand forecast Meteologica hourly

Content ID: 1790
Content Name: USA CAISO SDGE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_sdge_power_demand_forecast_hourly"
CONTENT_ID = 1790
