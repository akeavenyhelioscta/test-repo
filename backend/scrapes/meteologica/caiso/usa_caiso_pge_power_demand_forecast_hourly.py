"""
Meteologica: USA CAISO PGE power demand forecast Meteologica hourly

Content ID: 1788
Content Name: USA CAISO PGE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_caiso_pge_power_demand_forecast_hourly"
CONTENT_ID = 1788
