"""
Meteologica: USA PJM MidAtlantic PL power demand observation

Content ID: 2765
Content Name: USA PJM MidAtlantic PL power demand observation
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_pl_power_demand_observation"
CONTENT_ID = 2765
