"""
Meteologica: USA PJM MidAtlantic BC power demand projection hourly

Content ID: 2821
Content Name: USA PJM MidAtlantic BC power demand projection hourly
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_bc_power_demand_projection_hourly"
CONTENT_ID = 2821
