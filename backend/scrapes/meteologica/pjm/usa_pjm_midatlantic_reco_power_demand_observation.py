"""
Meteologica: USA PJM MidAtlantic RECO power demand observation

Content ID: 2777
Content Name: USA PJM MidAtlantic RECO power demand observation
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_reco_power_demand_observation"
CONTENT_ID = 2777
