"""
Meteologica: USA PJM Western-HUB day ahead power price forecast ECMWF ENS hourly

Content ID: 4400
Content Name: USA PJM Western-HUB day ahead power price forecast ECMWF ENS hourly
...
API_SCRAPE_NAME = "usa_pjm_western_hub_da_power_price_forecast_ecmwf_ens_hourly"
CONTENT_ID = 4400
...
def _format(df: pd.DataFrame, metadata: dict) -> pd.DataFrame:
    ...
    ens_rename = {c: f"ens_{c[3:]}_price" for c in df.columns if c.startswith("ENS")}
