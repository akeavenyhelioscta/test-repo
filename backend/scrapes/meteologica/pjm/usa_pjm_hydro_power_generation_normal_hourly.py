"""
Meteologica: USA PJM hydro power generation total normal hourly

Content ID: 4707
Content Name: USA PJM hydro power generation total normal hourly
...
API_SCRAPE_NAME = "usa_pjm_hydro_power_generation_normal_hourly"
CONTENT_ID = 4707
