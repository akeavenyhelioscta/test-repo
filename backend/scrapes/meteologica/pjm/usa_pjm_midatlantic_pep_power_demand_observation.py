"""
Meteologica: USA PJM MidAtlantic PEP power demand observation

Content ID: 2770
Content Name: USA PJM MidAtlantic PEP power demand observation
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_pep_power_demand_observation"
CONTENT_ID = 2770
