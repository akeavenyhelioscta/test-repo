"""
Meteologica: USA PJM MidAtlantic BC power demand observation

Content ID: 2768
Content Name: USA PJM MidAtlantic BC power demand observation
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_bc_power_demand_observation"
CONTENT_ID = 2768
