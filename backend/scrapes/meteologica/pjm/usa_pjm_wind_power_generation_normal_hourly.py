"""
Meteologica: USA PJM wind power generation normal hourly

Content ID: 2684
Content Name: USA PJM wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_pjm_wind_power_generation_normal_hourly"
CONTENT_ID = 2684
