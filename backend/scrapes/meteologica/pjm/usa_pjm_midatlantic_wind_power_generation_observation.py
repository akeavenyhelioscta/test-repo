"""
Meteologica: USA PJM MidAtlantic wind power generation observation

Content ID: 2682
Content Name: USA PJM MidAtlantic wind power generation observation
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_wind_power_generation_observation"
CONTENT_ID = 2682
