"""
Meteologica: USA PJM photovoltaic power generation normal hourly

Content ID: 2588
Content Name: USA PJM photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_pjm_pv_power_generation_normal_hourly"
CONTENT_ID = 2588
