"""
Meteologica: USA PJM photovoltaic power generation observation

Content ID: 2582
Content Name: USA PJM photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_pjm_pv_power_generation_observation"
CONTENT_ID = 2582
