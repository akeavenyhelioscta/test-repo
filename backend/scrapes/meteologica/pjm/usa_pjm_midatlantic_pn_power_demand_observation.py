"""
Meteologica: USA PJM MidAtlantic PN power demand observation

Content ID: 2762
Content Name: USA PJM MidAtlantic PN power demand observation
...
API_SCRAPE_NAME = "usa_pjm_midatlantic_pn_power_demand_observation"
CONTENT_ID = 2762
