"""
Meteologica: USA PJM wind power generation observation

Content ID: 2680
Content Name: USA PJM wind power generation observation
...
API_SCRAPE_NAME = "usa_pjm_wind_power_generation_observation"
CONTENT_ID = 2680
