"""
Meteologica: USA PJM wind power generation forecast Meteologica hourly

Content ID: 2604
Content Name: USA PJM wind power generation forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_pjm_wind_power_generation_forecast_hourly"
CONTENT_ID = 2604
