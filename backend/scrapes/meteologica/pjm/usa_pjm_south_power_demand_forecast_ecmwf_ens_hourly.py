"""
Meteologica: USA PJM SOUTH power demand forecast ECMWF ENS hourly

Content ID: 2758
Content Name: USA PJM SOUTH power demand forecast ECMWF ENS hourly
...
API_SCRAPE_NAME = "usa_pjm_south_power_demand_forecast_ecmwf_ens_hourly"
CONTENT_ID = 2758
