"""
Meteologica: USA PJM power demand forecast ECMWF ENS hourly

Content ID: 2724
Content Name: USA PJM power demand forecast ECMWF ENS hourly
...
API_SCRAPE_NAME = "usa_pjm_power_demand_forecast_ecmwf_ens_hourly"
CONTENT_ID = 2724
