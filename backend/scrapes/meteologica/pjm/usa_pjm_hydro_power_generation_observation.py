"""
Meteologica: USA PJM hydro power generation total observation

Content ID: 4706
Content Name: USA PJM hydro power generation total observation
...
API_SCRAPE_NAME = "usa_pjm_hydro_power_generation_observation"
CONTENT_ID = 4706
