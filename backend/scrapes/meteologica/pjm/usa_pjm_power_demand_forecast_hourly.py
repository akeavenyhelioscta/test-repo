"""
Meteologica: USA PJM power demand forecast Meteologica hourly

Content ID: 2706
Content Name: USA PJM power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_pjm_power_demand_forecast_hourly"
CONTENT_ID = 2706
