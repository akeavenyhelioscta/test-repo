"""
Meteologica: USA PJM West photovoltaic power generation observation

Content ID: 2583
Content Name: USA PJM West photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_pjm_west_pv_power_generation_observation"
CONTENT_ID = 2583
