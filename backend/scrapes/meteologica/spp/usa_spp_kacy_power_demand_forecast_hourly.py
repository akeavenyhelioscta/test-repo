"""
Meteologica: USA SPP KACY power demand forecast Meteologica hourly

Content ID: 2928
Content Name: USA SPP KACY power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_kacy_power_demand_forecast_hourly"
CONTENT_ID = 2928
