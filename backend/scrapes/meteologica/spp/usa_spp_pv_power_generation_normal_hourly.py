"""
Meteologica: USA SPP photovoltaic power generation normal hourly

Content ID: 2848
Content Name: USA SPP photovoltaic power generation normal hourly
...
API_SCRAPE_NAME = "usa_spp_pv_power_generation_normal_hourly"
CONTENT_ID = 2848
