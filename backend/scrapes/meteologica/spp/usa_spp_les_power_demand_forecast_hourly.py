"""
Meteologica: USA SPP LES power demand forecast Meteologica hourly

Content ID: 2933
Content Name: USA SPP LES power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_les_power_demand_forecast_hourly"
CONTENT_ID = 2933
