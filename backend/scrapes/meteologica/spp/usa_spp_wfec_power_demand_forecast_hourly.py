"""
Meteologica: USA SPP WFEC power demand forecast Meteologica hourly

Content ID: 2941
Content Name: USA SPP WFEC power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_wfec_power_demand_forecast_hourly"
CONTENT_ID = 2941
