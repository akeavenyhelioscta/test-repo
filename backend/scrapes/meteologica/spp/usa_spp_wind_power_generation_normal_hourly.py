"""
Meteologica: USA SPP wind power generation normal hourly

Content ID: 2919
Content Name: USA SPP wind power generation normal hourly
...
API_SCRAPE_NAME = "usa_spp_wind_power_generation_normal_hourly"
CONTENT_ID = 2919
