"""
Meteologica: USA SPP WACM power demand forecast Meteologica hourly

Content ID: 8580
Content Name: USA SPP WACM power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_wacm_power_demand_forecast_hourly"
CONTENT_ID = 8580
