"""
Meteologica: USA SPP INDN power demand forecast Meteologica hourly

Content ID: 2929
Content Name: USA SPP INDN power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_indn_power_demand_forecast_hourly"
CONTENT_ID = 2929
