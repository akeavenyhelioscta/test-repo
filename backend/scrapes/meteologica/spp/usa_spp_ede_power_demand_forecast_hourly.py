"""
Meteologica: USA SPP EDE power demand forecast Meteologica hourly

Content ID: 2930
Content Name: USA SPP EDE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_ede_power_demand_forecast_hourly"
CONTENT_ID = 2930
