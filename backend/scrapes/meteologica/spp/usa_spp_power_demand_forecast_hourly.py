"""
Meteologica: USA SPP power demand forecast Meteologica hourly

Content ID: 2927
Content Name: USA SPP power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_power_demand_forecast_hourly"
CONTENT_ID = 2927
