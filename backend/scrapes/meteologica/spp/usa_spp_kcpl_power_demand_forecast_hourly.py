"""
Meteologica: USA SPP KCPL power demand forecast Meteologica hourly

Content ID: 2932
Content Name: USA SPP KCPL power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_kcpl_power_demand_forecast_hourly"
CONTENT_ID = 2932
