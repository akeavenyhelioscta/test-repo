"""
Meteologica: USA SPP GRDA power demand forecast Meteologica hourly

Content ID: 2931
Content Name: USA SPP GRDA power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_grda_power_demand_forecast_hourly"
CONTENT_ID = 2931
