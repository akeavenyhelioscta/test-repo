"""
Meteologica: USA SPP MPS power demand forecast Meteologica hourly

Content ID: 2934
Content Name: USA SPP MPS power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_mps_power_demand_forecast_hourly"
CONTENT_ID = 2934
