"""
Meteologica: USA SPP SECI power demand forecast Meteologica hourly

Content ID: 2938
Content Name: USA SPP SECI power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_seci_power_demand_forecast_hourly"
CONTENT_ID = 2938
