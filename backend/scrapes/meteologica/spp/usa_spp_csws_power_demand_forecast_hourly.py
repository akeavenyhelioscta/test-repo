"""
Meteologica: USA SPP CSWS power demand forecast Meteologica hourly

Content ID: 2926
Content Name: USA SPP CSWS power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_csws_power_demand_forecast_hourly"
CONTENT_ID = 2926
