"""
Meteologica: USA SPP OKGE power demand forecast Meteologica hourly

Content ID: 2937
Content Name: USA SPP OKGE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_okge_power_demand_forecast_hourly"
CONTENT_ID = 2937
