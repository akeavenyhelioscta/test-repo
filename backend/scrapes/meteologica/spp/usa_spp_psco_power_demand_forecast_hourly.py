"""
Meteologica: USA SPP PSCO power demand forecast Meteologica hourly

Content ID: 8575
Content Name: USA SPP PSCO power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_psco_power_demand_forecast_hourly"
CONTENT_ID = 8575
