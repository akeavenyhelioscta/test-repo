"""
Meteologica: USA SPP SPRM power demand forecast Meteologica hourly

Content ID: 2940
Content Name: USA SPP SPRM power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_sprm_power_demand_forecast_hourly"
CONTENT_ID = 2940
