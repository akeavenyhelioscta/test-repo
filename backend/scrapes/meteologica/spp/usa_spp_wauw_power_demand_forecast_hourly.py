"""
Meteologica: USA SPP WAUW power demand forecast Meteologica hourly

Content ID: 8585
Content Name: USA SPP WAUW power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_wauw_power_demand_forecast_hourly"
CONTENT_ID = 8585
