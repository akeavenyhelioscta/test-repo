"""
Meteologica: USA SPP wind power generation observation

Content ID: 2912
Content Name: USA SPP wind power generation observation
...
API_SCRAPE_NAME = "usa_spp_wind_power_generation_observation"
CONTENT_ID = 2912
