"""
Meteologica: USA SPP wind power generation forecast Meteologica hourly

Content ID: 2856
Content Name: USA SPP wind power generation forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_wind_power_generation_forecast_hourly"
CONTENT_ID = 2856
