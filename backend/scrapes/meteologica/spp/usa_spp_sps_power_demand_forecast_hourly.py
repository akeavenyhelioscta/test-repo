"""
Meteologica: USA SPP SPS power demand forecast Meteologica hourly

Content ID: 2939
Content Name: USA SPP SPS power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_sps_power_demand_forecast_hourly"
CONTENT_ID = 2939
