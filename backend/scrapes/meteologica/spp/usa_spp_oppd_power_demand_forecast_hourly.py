"""
Meteologica: USA SPP OPPD power demand forecast Meteologica hourly

Content ID: 2936
Content Name: USA SPP OPPD power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_oppd_power_demand_forecast_hourly"
CONTENT_ID = 2936
