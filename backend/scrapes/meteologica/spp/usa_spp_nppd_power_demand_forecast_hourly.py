"""
Meteologica: USA SPP NPPD power demand forecast Meteologica hourly

Content ID: 2935
Content Name: USA SPP NPPD power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_nppd_power_demand_forecast_hourly"
CONTENT_ID = 2935
