"""
Meteologica: USA SPP WAUE power demand forecast Meteologica hourly

Content ID: 2942
Content Name: USA SPP WAUE power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_waue_power_demand_forecast_hourly"
CONTENT_ID = 2942
