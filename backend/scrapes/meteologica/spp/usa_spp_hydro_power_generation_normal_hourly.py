"""
Meteologica: USA SPP hydro power generation total normal hourly

Content ID: 4702
Content Name: USA SPP hydro power generation total normal hourly
...
API_SCRAPE_NAME = "usa_spp_hydro_power_generation_normal_hourly"
CONTENT_ID = 4702
