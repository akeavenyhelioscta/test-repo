"""
Meteologica: USA SPP WR power demand forecast Meteologica hourly

Content ID: 2943
Content Name: USA SPP WR power demand forecast Meteologica hourly
...
API_SCRAPE_NAME = "usa_spp_wr_power_demand_forecast_hourly"
CONTENT_ID = 2943
