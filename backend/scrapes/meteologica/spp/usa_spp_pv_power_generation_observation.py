"""
Meteologica: USA SPP photovoltaic power generation observation

Content ID: 2845
Content Name: USA SPP photovoltaic power generation observation
...
API_SCRAPE_NAME = "usa_spp_pv_power_generation_observation"
CONTENT_ID = 2845
