...
from backend.scrapes.gas_ebbs import notice_classifier, outage_extractor
...
class EBBScraper(ABC):
    ...
    def _fetch_details(self, df: pd.DataFrame, logger) -> pd.DataFrame:
        ...
        if detail_rows:
            ...
            # Sanitize detail_text: strip null bytes, newlines, tabs that break CSV COPY
...
def _ensure_adapters_loaded():
    ...
    from backend.scrapes.gas_ebbs.adapters import piperiv_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import enbridge_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import kindermorgan_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import williams_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import energytransfer_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import tce_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import tcplus_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import quorum_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import bhegts_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import northern_natural_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import dtmidstream_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import gasnom_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import tallgrass_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import cheniere_adapter  # noqa: F401
    from backend.scrapes.gas_ebbs.adapters import standalone_adapter  # noqa: F401
